...
react(),
    ...
    // The SQLite WASM module must not be pre-bundled by esbuild: it loads its
    // own .wasm sibling at runtime and dep-optimising it breaks that lookup.
    // Required by @sqlite.org/sqlite-wasm — see its README's Vite section.
    optimizeDeps: {
